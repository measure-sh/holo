...
const TOKYO_NIGHT: Theme = Theme {
    ...
    spark_disk:   Color::Rgb(0xbb, 0x9a, 0xf7),
    spark_rx:     Color::Rgb(0xff, 0x7a, 0x93),
...
const AKAITO: Theme = Theme {
    ...
    spark_cpu:    Color::Rgb(0x6b, 0x1d, 0x12),
    spark_mem:    Color::Rgb(0xa3, 0x2f, 0x1a),
    spark_disk:   Color::Rgb(0xc2, 0x41, 0x0c),
    spark_rx:     Color::Rgb(0xb4, 0x53, 0x09),
    spark_tx:     Color::Rgb(0x85, 0x4d, 0x0e),
};
...
const DARK: Theme = Theme {
    ...
    spark_disk:   Color::Rgb(0xf4, 0x3f, 0x5e),
    spark_rx:     Color::Rgb(0xd9, 0x46, 0xef),
    spark_tx:     Color::Rgb(0x8b, 0x5c, 0xf6),
};
...
const LIGHT: Theme = Theme {
    ...
    spark_disk:   Color::Rgb(0xbe, 0x12, 0x3c),
    spark_rx:     Color::Rgb(0xa2, 0x1c, 0xaf),
