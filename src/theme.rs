...
pub struct Theme {
    ...
    pub spark_cpu: Color,
    pub spark_mem: Color,
    pub spark_java: Color,
    pub spark_native: Color,
...
const TOKYO_NIGHT: Theme = Theme {
    ...
    spark_cpu:    Color::Rgb(0x7a, 0xa2, 0xf7),
    spark_mem:    Color::Rgb(0xbb, 0x9a, 0xf7),
    spark_java:   Color::Rgb(0xe0, 0xaf, 0x68),
    spark_native: Color::Rgb(0xf7, 0x76, 0x8e),
    spark_disk:   Color::Rgb(0x0d, 0xb9, 0xd7),
    spark_rx:     Color::Rgb(0x9e, 0xce, 0x6a),
    spark_tx:     Color::Rgb(0xff, 0x9e, 0x64),
};
...
const AKAITO: Theme = Theme {
    ...
    spark_cpu:    Color::Rgb(0x1f, 0x5a, 0x4a),
    spark_mem:    Color::Rgb(0x6b, 0x3f, 0x8a),
    spark_java:   Color::Rgb(0xa8, 0x61, 0x1f),
    spark_native: Color::Rgb(0xa4, 0x37, 0x3c),
    spark_disk:   Color::Rgb(0x2f, 0x61, 0x70),
    spark_rx:     Color::Rgb(0x4a, 0x7c, 0x3c),
    spark_tx:     Color::Rgb(0xa3, 0x2f, 0x1a),
};
...
const DARK: Theme = Theme {
    ...
    spark_cpu:    Color::Rgb(0x22, 0xd3, 0xee),
    spark_mem:    Color::Rgb(0xc0, 0x84, 0xfc),
    spark_java:   Color::Rgb(0xfb, 0xbf, 0x24),
    spark_native: Color::Rgb(0xf4, 0x72, 0xb6),
    spark_disk:   Color::Rgb(0x2d, 0xd4, 0xbf),
    spark_rx:     Color::Rgb(0x34, 0xd3, 0x99),
    spark_tx:     Color::Rgb(0xfb, 0x92, 0x3c),
};
...
const LIGHT: Theme = Theme {
    ...
    spark_cpu:    Color::Rgb(0x08, 0x91, 0xb2),
    spark_mem:    Color::Rgb(0x7c, 0x3a, 0xed),
    spark_java:   Color::Rgb(0xb4, 0x53, 0x09),
    spark_native: Color::Rgb(0xbe, 0x18, 0x5d),
    spark_disk:   Color::Rgb(0x0d, 0x94, 0x88),
    spark_rx:     Color::Rgb(0x16, 0xa3, 0x4a),
    spark_tx:     Color::Rgb(0xc2, 0x57, 0x0a),
};
