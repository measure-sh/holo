...
const TOKYO_NIGHT: Theme = Theme {
    ...
    overlay:      Color::Rgb(0x16, 0x16, 0x1e),
    ...
    surface:      Color::Rgb(0x3b, 0x42, 0x61),
    muted:        Color::Rgb(0x56, 0x5f, 0x89),
    spark_cpu:    Color::Rgb(0xb4, 0xf9, 0xf8),
    spark_mem:    Color::Rgb(0x7d, 0xcf, 0xff),
    spark_disk:   Color::Rgb(0x7a, 0xa2, 0xf7),
    spark_rx:     Color::Rgb(0x2a, 0xc3, 0xde),
    spark_tx:     Color::Rgb(0x3d, 0x59, 0xa1),
};
...
const AKAITO: Theme = Theme {
    ...
    spark_cpu:    Color::Rgb(0xe4, 0x8e, 0x3e),
    spark_mem:    Color::Rgb(0xe8, 0x4d, 0x31),
    spark_disk:   Color::Rgb(0xa8, 0x61, 0x1f),
    spark_rx:     Color::Rgb(0xa4, 0x37, 0x3c),
